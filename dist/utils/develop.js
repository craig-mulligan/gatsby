...
var startServer = function () {
  var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2(program) {
    var _this = this;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 9:
            ...
            listener = server.listen(program.port, program.host, function (e) {
              if (e) {
            ...
            watchGlobs = ["src/html.js", "**/gatsby-ssr.js"].map(directoryPath);

            chokidar.watch(watchGlobs).on("change", (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee() {
