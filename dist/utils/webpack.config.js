...
var GatsbyModulePlugin = require("../loaders/gatsby-module-loader/plugin");
...
module.exports = function () {
  var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(program, directory, suppliedStage) {
          ...
          case 0:
            ...
            resolve = function resolve() {
              ...
              return {
                ...
                extensions: [""].concat((0, _toConsumableArray3.default)(program.extensions)),
                ...
                // part of your site.
                modulesDirectories: [directoryPath("node_modules"), "node_modules", directoryPath("node_modules", "gatsby", "node_modules")]
              };
            };
              ...
              switch (stage) {
                case "develop":
                  return [new _webpack2.default.optimize.OccurenceOrderPlugin(), new _webpack2.default.HotModuleReplacementPlugin(), new _webpack2.default.NoErrorsPlugin(), new _webpack2.default.DefinePlugin({
                    ...
                    __PATH_PREFIX__: (0, _stringify2.default)(store.getState().config.pathPrefix)
                  }),
                ...
                case "develop-html":
                  return [new _staticSiteGeneratorWebpackPlugin2.default("render-page.js", pages), new _webpack2.default.DefinePlugin({
                    "process.env": processEnv(stage, "development"),
                    __PREFIX_PATHS__: program.prefixPaths,
                    __PATH_PREFIX__: (0, _stringify2.default)(store.getState().config.pathPrefix)
                ...
                case "build-javascript":
                  {
                    ...
                    new _webpack2.default.optimize.CommonsChunkPlugin({
                      name: "commons",
                      chunks: ["app"].concat((0, _toConsumableArray3.default)(components)),
                    ...
                    new _extractTextWebpackPlugin2.default("build-js-styles.css"),
            ...
            processEnv = function processEnv(stage, defaultNodeEnv) {
              ...
              var envObject = (0, _keys2.default)(parsed).reduce(function (acc, key) {
                acc[key] = (0, _stringify2.default)(parsed[key]);
                return acc;
              }, {});

              // Don't allow overwriting of NODE_ENV, PUBLIC_DIR as to not break gatsby things
              envObject.NODE_ENV = (0, _stringify2.default)(env);
              envObject.PUBLIC_DIR = (0, _stringify2.default)(process.cwd() + "/public");
