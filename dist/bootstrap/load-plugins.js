...
module.exports = function () {
  var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee() {
    ...
    var plugins, processPlugin, flattenedPlugins, extractPlugins, apis, badExports, stringSimiliarity, _require2, stripIndent;
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            flattenedPlugins.forEach(function (plugin) {
              ...
              if (gatsbyNode) {
                badExports = badExports.concat(_.without.apply(_, [_.keys(gatsbyNode)].concat((0, _toConsumableArray3.default)(apis))).map(function (e) {
                  return {
                    exportName: e,
            ...
            if (badExports.length > 0) {
              ...
              console.log("\n");
              console.log(stripIndent(_templateObject));
