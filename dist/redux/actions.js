 ...
 * deleteNode(node.id)
 */
actions.deleteNode = function (nodeId) {
  var plugin = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "";
...
actions.createNode = function (node, plugin, traceId) {
  ...
  if (node.internal.owner) {
    console.log((0, _stringify2.default)(node, null, 4));
  ...
  if (node.fields) {
    throw new Error(stripIndent(_templateObject, (0, _stringify2.default)(node, null, 4), (0, _stringify2.default)(plugin, null, 4)));
  }
  ...
  if (!typeOwners[node.internal.type] && plugin) {
    ...
    if (typeOwners[node.internal.type] !== plugin.name) {
      throw new Error(stripIndent(_templateObject2, plugin.name, node.internal.type, typeOwners[node.internal.type], (0, _stringify2.default)(node, null, 4), (0, _stringify2.default)(plugin, null, 4)));
    }
  }
  ...
  if (oldNode && oldNode.internal.owner !== plugin.name) {
    throw new Error(stripIndent(_templateObject3, node.id, oldNode.internal.owner, plugin.name));
  }
...
actions.createNodeField = function (_ref, plugin, traceId) {
  ...
  if (fieldOwner && fieldOwner !== plugin.name) {
    throw new Error(stripIndent(_templateObject4, node.id, plugin.name, name, value));
  }
