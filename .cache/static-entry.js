...
var getLayout = function getLayout(path) {
  var page = _pages2.default.find(function (page) {
    return page.path === path;
  });
  var layout = void 0;
  if (_syncRequires2.default.layouts[page.layoutComponentChunkName]) {
    layout = _syncRequires2.default.layouts[page.layoutComponentChunkName];
  } else {
...
module.exports = function (locals, callback) {
  ...
  var bodyComponent = $(_reactRouterDom.StaticRouter, {
    ...
    context: {}
  }, $((0, _reactRouterDom.withRouter)(getLayout(locals.path)), {
